...
{
    if (!_display || !_motionControl) return;
...
{
    if (!_display || !_turningMode) return;
...
void MenuSystem::cycleTurningFeedRate(bool increase)
{
    ...
    if (increase) {
        switch (currentRate) {
            case TurningMode::FeedRate::F0_01: newRate = TurningMode::FeedRate::F0_02; break;
            case TurningMode::FeedRate::F0_02: newRate = TurningMode::FeedRate::F0_05; break;
            case TurningMode::FeedRate::F0_05: newRate = TurningMode::FeedRate::F0_10; break;
            case TurningMode::FeedRate::F0_10: newRate = TurningMode::FeedRate::F0_20; break;
            case TurningMode::FeedRate::F0_20: newRate = TurningMode::FeedRate::F0_50; break;
            case TurningMode::FeedRate::F0_50: newRate = TurningMode::FeedRate::F1_00; break;
            case TurningMode::FeedRate::F1_00: newRate = TurningMode::FeedRate::F1_00; break; // Maximum
        }
    } else {
        switch (currentRate) {
            case TurningMode::FeedRate::F0_01: newRate = TurningMode::FeedRate::F0_01; break; // Minimum
            case TurningMode::FeedRate::F0_02: newRate = TurningMode::FeedRate::F0_01; break;
            case TurningMode::FeedRate::F0_05: newRate = TurningMode::FeedRate::F0_02; break;
            case TurningMode::FeedRate::F0_10: newRate = TurningMode::FeedRate::F0_05; break;
            case TurningMode::FeedRate::F0_20: newRate = TurningMode::FeedRate::F0_10; break;
            case TurningMode::FeedRate::F0_50: newRate = TurningMode::FeedRate::F0_20; break;
            case TurningMode::FeedRate::F1_00: newRate = TurningMode::FeedRate::F0_50; break;
        }
    }
...
{
    if (!_display || !_threadingMode) return;
